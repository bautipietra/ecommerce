          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 sm:gap-12 lg:grid-cols-2">
              <div className='grid mb-8 sm:py-16'>
                ...
                <a href="#" className="justify-self-center lg:justify-self-start inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-black lg:mt-16 hover:bg-zinc-900 focus:bg-zinc-900" role="button">
                  Shop now
