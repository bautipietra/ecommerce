    ...
    <div>
      ...
      <nav className="flex justify-between bg-white text-black w-screen">
        ...
        <div className='flex gap-4 items-center'>
          <Link className="md:hidden flex items-center" to="#">
          ...
          <button onClick={() => setMenu(!menu)} className="navbar-burger self-center mr-12 md:hidden z-20">
            {menu ?
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000" className="bi bi-x-lg h-6 w-6" viewBox="0 0 16 16">
                <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z" />
              </svg> :
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#000" className="bi bi-list h-6 w-6" viewBox="0 0 16 16">
