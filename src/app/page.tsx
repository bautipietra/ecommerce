        ...
        <section className="bg-white bg-opacity-30 py-10 sm:py-16 lg:py-16">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid items-center grid-cols-1 sm:gap-12 lg:grid-cols-2">
              <div className='mb-8 sm:py-16'>
                <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">Great way to boost  your <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-600 to-zinc-400">style!</span></h1>
                {/* <p className="mt-4 text-base text-black lg:mt-8 sm:text-xl">Grow your career fast with right mentor.</p> */}
                <a href="#" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-black lg:mt-16 hover:bg-zinc-900 focus:bg-zinc-900" role="button">
                  Shop now
      ...
      <div className="p-6 py-12 bg-black text-white">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <a href="#" rel="noreferrer noopener" className="px-5 mt-4 lg:mt-0 py-3 border block dark:bg-gray-50 dark:text-gray-900 dark:border-gray-400">Shop Now</a>
          </div>
        </div>
      </div>
        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="grid items-center gap-4 xl:grid-cols-5">
            <div className="max-w-2xl mx-auto my-8 space-y-4 text-center xl:col-span-2 xl:text-left">
              ...
              <Link href={'/reviews'} className="mt-1.5 inline-block bg-black px-5 py-3 text-xs font-medium uppercase tracking-wide text-white">
                See all reviews
              </Link>
            </div>
